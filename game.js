var Game = function() {
  ...
  settings.spaceshipSpeed = 0; // The speed of the spaceship
  settings.walls = true; // The spaceship can not go outside the screen (true cannot go out, false can go out)
    ...
    document.addEventListener('keyup', function(event) {
      ...
      switch (keyName) {
        ...
        case "ArrowLeft":
          ...
          break;
          // case "ArrowUp":                    // don't need
          //     interactions.up = false;
          //     break;
          // case "ArrowDown":                    // don't need
